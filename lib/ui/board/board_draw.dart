      ...
      child: Container(
        ...
        child: Listener(
            ...
            child: RepaintBoundary(
              child: CustomPaint(
                painter: SampleDrawPainter(widget.controller),
...
/// class for interaction with draw widget
/// manages points representing draw on canvas
/// provides draw manipulation functions (export, clear)
class DrawController extends ValueNotifier<List<Point>> {
  ...
  Future<ui.Image?> toImage({int? width, int? height}) async {
    ...
    SampleDrawPainter(this, penColor: exportPenColor).paint(
      canvas,
      Size.infinite,
    );
...
class SampleDrawPainter extends CustomPainter {
  SampleDrawPainter(this._controller, {Color? penColor})
      : _penStyle = Paint(),
...
class SampleDrawPage extends StatefulWidget {
  const SampleDrawPage({super.key});

  @override
  State<SampleDrawPage> createState() => _SampleDrawPageState();
}

class _SampleDrawPageState extends State<SampleDrawPage> {
